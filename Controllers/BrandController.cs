...
namespace InventoryManger.Controllers
{
    ...
    public class BrandController : Controller
    {
        ...
        {
            Brand items = new Brand();
            return View(items);
        }
        [HttpPost]
        public IActionResult Create(Brand items)
        {
            bool bolret = false;
            string errMessage = "";
            try
        ...
        {
            Brand items = _Repo.GetItem(id);
            TempData.Keep();
            return View(items);
        }
        [HttpPost]
        public IActionResult Edit(Brand items)
        {
            bool bolret = false;
            string errMessage = "";
            try
        ...
        [HttpPost]
        public IActionResult Delete(Brand items)
        {
            try
            {
